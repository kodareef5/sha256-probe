...
May 23 continuation checkpoint 36:

- committed checkpoint 35 as bf062e80 with author and committer set to
  kodareef5 <kodareef5@users.noreply.github.com>
- breadth phases 716-731 completed without a tail<=13 or R61<=8 move
- phase716 local refinement preserved the window 7445 R61=10 row
  W1=0x061c,0x0522,0x2622 and W2=0x0529,0x2729,0x3fbf; it also improved
  window 4373 to R61=12 and window 6165 from scan tail21 to tail19/R61=12
- phase717 local refinement preserved the window 4133 tail17 row, improved
  its local R61 side to 13, and preserved selected R61=11 rows at windows
  5413, 3877, and 1829
- phase718 local refinement preserved the window 5685 tail16 row and the
  R61=10 rows at windows 5429 and 7221; it also improved window 2101 to
  R61=12 and window 5429 from scan tail22 to tail21
- phase719 local refinement improved window 69 from scan tail22 to
  tail16/R61=12, preserved tail17 at window 6725, and preserved or shaped
  selected R61=11 rows at windows 5445, 837, and 1093
- phase720 local refinement preserved window 2133 at tail16/R61=13,
  preserved window 3669 at tail18/R61=12, and improved window 2389 from scan
  tail22 to tail18/R61=12
- phase721 breadth/local re-hit the tail14 row at window 3173, preserved the
  window 357 R61=10 row, improved window 101 from R61=14 to R61=12, and
  improved window 4965 from R61=12 to R61=11
- phase722 local refinement preserved the window 4725 R61=10 row, improved
  window 1653 from R61=13 to R61=11, and improved window 6005 from scan
  tail21 to tail19/R61=12
- phase723 local refinement preserved the window 1925 tail17/R61=12 row and
  selected R61=11 rows at windows 3717, 4229, and 2181; it also improved
  window 2437 from scan tail21 to tail19/R61=12
- phase724 local refinement improved window 405 from scan tail22 to
  tail18/R61=11, preserved tail18 rows at windows 1173 and 4757, and shaped
  windows 7317 and 1429 to R61=12
- phase725 local refinement preserved tail17 at window 7333 and the window
  2725 R61=10 row; it improved window 6309 from scan tail21 to tail20/R61=11
  and shaped window 5797 from R61=13 to R61=11
- phase726 local refinement was weaker, bottoming at tail19 and R61=11; it
  improved windows 4277 and 6069 to R61=12 while preserving the window 437
  R61=11 row
- phase727 breadth produced a tail15 row at window 197 and an R61=10 row at
  window 5061; local refinement preserved those rows, shaped window 7877 to
  tail17/R61=10, and improved window 3269 to R61=11
- phase728 local refinement preserved a tail18 row at window 7893 and R61=11
  rows at windows 7381, 4053, 6613, and 725
- phase729 breadth/local preserved the joint tail16/R61=11 row at window
...
- phase730 breadth produced a tail16/R61=14 row at window 6901; local
  refinement preserved tail16 and improved its local R61 side to 12, and
  improved window 7669 from scan tail21 to tail19/R61=11
- phase731 was weaker, bottoming at tail19 and R61=11; local refinement
  preserved the window 6917 R61=11 row and did not improve the frontier

May 23 continuation checkpoint 37:

- committed checkpoint 36 as e391089a with author and committer set to
  kodareef5 <kodareef5@users.noreply.github.com>
- breadth phases 732-739 completed without a tail<=13 or R61<=8 move
- phase732 local refinement preserved the window 7445 R61=10 row
  W1=0x061c,0x0522,0x2622 and W2=0x0529,0x2729,0x3fbf; it also improved
  window 4373 to R61=12 and window 6165 from scan tail21 to tail19/R61=12
- phase733 local refinement preserved the window 4133 tail17 row, improved
  its local R61 side to 13, improved window 1573 to R61=12, and preserved
  selected R61=11 rows at windows 5413, 3877, and 1829
- phase734 local refinement preserved the window 5685 tail16 row and the
  R61=10 rows at windows 5429 and 7221; it also improved window 2101 to
  R61=12 and window 5429 from scan tail22 to tail21
- phase735 local refinement improved window 69 from scan tail22 to
  tail16/R61=12, preserved tail17 at window 6725, and preserved or shaped
  selected R61=11 rows at windows 5445, 837, and 1093
- phase736 local refinement preserved window 2133 at tail16/R61=13,
  preserved window 3669 at tail18/R61=12, and improved window 2389 from scan
  tail22 to tail18/R61=12
- phase737 breadth/local re-hit the tail14 row at window 3173,
  W1=0x3c4a,0x0174,0x205b and W2=0x3b57,0x37bc,0x2a96; local refinement
...
- phase738 local refinement preserved the window 4725 R61=10 row, improved
  window 1653 from R61=13 to R61=11, and improved window 6005 from scan
  tail21 to tail19/R61=12
...
May 23 continuation checkpoint 40:

- committed checkpoint 39 as 900ee1d6 with author and committer set to
  kodareef5 <kodareef5@users.noreply.github.com>
- breadth phases 756-763 completed without a tail<=13 or R61<=8 move
- phase756 local refinement improved window 405 from scan tail22 to
  tail18/R61=11, preserved tail18 rows at windows 1173 and 4757, preserved
  R61=11 rows at windows 405, 4245, and 5525, and shaped windows 7317 and
  1429 to R61=12
- phase757 local refinement preserved tail17 at window 7333 and the window
  2725 R61=10 row; it preserved or shaped R61=11 rows at windows 933, 6309,
  and 5797, including window 5797 moving from scan R61=13 to R61=11
- phase758 was weaker, bottoming at tail19 and R61=11; local refinement
  improved window 4277 from R61=14 to R61=12, improved window 6069 from scan
  tail20 to tail19/R61=12, preserved the window 437 R61=11 row, and shaped
  window 4021 from scan tail22 to tail20/R61=12
- phase759 breadth produced a tail15 row at window 197 and an R61=10 row at
  window 5061; local refinement preserved those rows, shaped window 7877 to
  tail17/R61=10, improved window 3269 to R61=11, improved window 6341 from
  scan tail22 to tail18/R61=13, and carried tail20/R61=12 rows at windows
  6853 and 709
- phase760 local refinement preserved a tail18 row at window 7893 and R61=11
  rows at windows 7381, 4053, 6613, and 725; it also improved the local
  R61 side at window 7893 from 14 to 12
- phase761 breadth/local preserved the joint tail16/R61=11 row at window
  6629, W1=0x0221,0x2b8d,0x010d and W2=0x012e,0x2f07,0x38d2; local
  refinement also shaped window 7397 to R61=10 and window 5861 to R61=11
- phase762 breadth/local preserved the window 6901 tail16 row,
  W1=0x221b,0x3351,0x26a1 and W2=0x2128,0x3d26,0x04b4; local refinement
  improved its local R61 side from 14 to 12, improved window 7669 from scan
  tail21 to tail19/R61=11, and improved window 6645 from scan tail22 to
  tail20/R61=12
- phase763 was weaker on tail depth, bottoming at tail19; local refinement
...
May 23 continuation checkpoint 41:

- committed checkpoint 40 as 009d117c with author and committer set to
  kodareef5 <kodareef5@users.noreply.github.com>
- breadth phases 764-771 completed without a tail<=13 or R61<=8 move
- phase764 breadth/local re-hit the window 7445 R61=10 row; local refinement
  preserved it, improved window 4373 from R61=15 to R61=12, and improved
  window 6165 from scan tail21 to tail19/R61=12
- phase765 breadth produced tail17 at window 4133, tail18 at window 1573,
  and R61=11 rows at windows 5413, 3877, and 1829; local refinement
  preserved those rows and improved windows 4133, 1573, 5669, and 293 on the
  R61 side
- phase766 breadth/local preserved tail16 at window 5685 and R61=10 rows at
  windows 7221 and 5429; local refinement also improved window 2101 to
  R61=12 and window 5429 from scan tail22 to tail21/R61=10
- phase767 local refinement improved window 69 from scan tail22 to
...
- phase768 local refinement preserved the window 2133 tail16 row, improved
  its local R61 side from 14 to 13, preserved tail18 at windows 3669 and
  7253, and improved window 2389 from scan tail22 to tail18/R61=12
- phase769 breadth/local re-hit the tail14 row at window 3173,
  W1=0x3c4a,0x0174,0x205b and W2=0x3b57,0x37bc,0x2a96; local refinement
  improved its local R61 side from 15 to 13, preserved the window 357 R61=10
  row, improved window 101 from R61=14 to R61=12, and improved window 4965
  from R61=12 to R61=11
- phase770 breadth/local preserved the window 4725 R61=10 row, improved
  window 1653 from R61=13 to R61=11, improved window 6005 from scan tail21
  to tail19/R61=12, and preserved the window 7285 R61=11 row
- phase771 local refinement preserved the window 1925 tail17/R61=12 row and
...
May 23 continuation checkpoint 42:

- committed checkpoint 41 as 3212bc3b with author and committer set to
  kodareef5 <kodareef5@users.noreply.github.com>
- breadth phases 772-779 completed without a tail<=13 or R61<=8 move
- phase772 local refinement improved window 405 from scan tail22 to
  tail18/R61=11, preserved tail18 rows at windows 1173 and 4757, preserved
  R61=11 rows at windows 405, 4245, and 5525, and shaped windows 7317 and
  1429 to R61=12
- phase773 local refinement preserved tail17 at window 7333 and the window
  2725 R61=10 row; it preserved R61=11 rows at windows 933 and 6309, shaped
  window 5797 from scan R61=13 to R61=11, and improved window 7333 on the
  R61 side from 13 to 12
- phase774 was weaker, bottoming at tail19 and R61=11; local refinement
  improved window 4277 from R61=14 to R61=12, improved window 6069 from scan
  tail20 to tail19/R61=12, improved window 437 from scan tail22 to
  tail20/R61=11, and shaped window 4021 to tail20/R61=12
- phase775 breadth produced a tail15 row at window 197 and an R61=10 row at
  window 5061; local refinement preserved those rows, shaped window 7877
  from scan tail18/R61=13 to tail17/R61=10, improved window 3269 to
  R61=11, and improved window 6341 from scan tail22 to tail18/R61=13
- phase776 local refinement preserved a tail18 row at window 7893 and R61=11
  rows at windows 7381, 4053, 6613, and 725; it also improved the local
  R61 side at window 7893 from 14 to 12 and improved the tail side at
  windows 4053, 6613, and 725
- phase777 breadth/local preserved the joint tail16/R61=11 row at window
  6629, W1=0x0221,0x2b8d,0x010d and W2=0x012e,0x2f07,0x38d2; local
  refinement also shaped window 7397 to R61=10 and window 5861 to R61=11
- phase778 breadth/local preserved the window 6901 tail16 row,
  W1=0x221b,0x3351,0x26a1 and W2=0x2128,0x3d26,0x04b4; local refinement
  improved its local R61 side from 14 to 12, improved window 7669 from scan
  tail21 to tail19/R61=11, and improved window 6645 from scan tail22 to
  tail20/R61=12
- phase779 was weaker on tail depth, bottoming at tail19; local refinement
  preserved the window 6917 R61=11 row, improved window 3589 from R61=14 to
  R61=13, and improved window 5125 from scan tail23 to tail22/R61=12

May 23 continuation checkpoint 43:

- committed checkpoint 42 as 28b42110 with author and committer set to
  kodareef5 <kodareef5@users.noreply.github.com>
- breadth phases 780-787 completed without a tail<=13 or R61<=8 move
- phase780 breadth/local re-hit the window 7445 R61=10 row; local refinement
  preserved it, improved window 4373 from R61=15 to R61=12, and improved
  window 6165 from scan tail21 to tail19/R61=12
- phase781 breadth produced tail17 at window 4133, tail18 at window 1573,
  and R61=11 rows at windows 5413, 3877, and 1829; local refinement
  preserved those rows and improved windows 4133, 1573, 5669, and 293 on the
  R61 side
- phase782 breadth/local preserved tail16 at window 5685 and R61=10 rows at
  windows 7221 and 5429; local refinement also improved window 2101 to
  R61=12 and window 5429 from scan tail22 to tail21/R61=10
- phase783 local refinement improved window 69 from scan tail22 to
  tail16/R61=12, preserved tail17 at window 6725, preserved R61=11 rows at
  windows 5445 and 837, and improved window 1093 from R61=13 to R61=11
- phase784 local refinement preserved the window 2133 tail16 row, improved
  its local R61 side from 14 to 13, preserved tail18 at windows 3669 and
  7253, and improved window 2389 from scan tail22 to tail18/R61=12
- phase785 breadth/local re-hit the tail14 row at window 3173,
  W1=0x3c4a,0x0174,0x205b and W2=0x3b57,0x37bc,0x2a96; local refinement
  improved its local R61 side from 15 to 13, preserved the window 357 R61=10
  row, improved window 101 from R61=14 to R61=12, and improved window 4965
  from R61=12 to R61=11
- phase786 breadth/local preserved the window 4725 R61=10 row, improved
  window 1653 from R61=13 to R61=11, improved window 6005 from scan tail21
  to tail19/R61=12, and preserved the window 7285 R61=11 row
- phase787 local refinement preserved the window 1925 tail17/R61=12 row and
  R61=11 rows at windows 3717, 4229, and 2181; it also improved window 2437
  from scan tail21 to tail19/R61=12 and improved window 4741 from R61=13 to
  R61=12

May 23 continuation checkpoint 44:

- committed checkpoint 43 as 1b762224 with author and committer set to
  kodareef5 <kodareef5@users.noreply.github.com>
- breadth phases 788-795 completed without a tail<=13 or R61<=8 move
- phase788 local refinement improved window 405 from scan tail22 to
  tail18/R61=11, preserved tail18 rows at windows 1173 and 4757, preserved
  R61=11 rows at windows 405, 4245, and 5525, and shaped windows 7317 and
  1429 to R61=12
- phase789 local refinement preserved tail17 at window 7333 and the window
  2725 R61=10 row; it preserved R61=11 rows at windows 933 and 6309, shaped
  window 5797 from scan R61=13 to R61=11, and improved window 7333 on the
  R61 side from 13 to 12
- phase790 was weaker, bottoming at tail19 and R61=11; local refinement
  improved window 4277 from R61=14 to R61=12, improved window 6069 from scan
  tail20 to tail19/R61=12, improved window 437 from scan tail22 to
  tail20/R61=11, and shaped window 4021 to tail20/R61=12
- phase791 breadth produced a tail15 row at window 197 and an R61=10 row at
  window 5061; local refinement preserved those rows, shaped window 7877
  from scan tail18/R61=13 to tail17/R61=10, improved window 3269 to
  R61=11, and improved window 6341 from scan tail22 to tail18/R61=13
- phase792 local refinement preserved a tail18 row at window 7893 and R61=11
  rows at windows 7381, 4053, 6613, and 725; it also improved the local
  R61 side at window 7893 from 14 to 12 and improved the tail side at
  windows 4053, 6613, and 725
- phase793 breadth/local preserved the joint tail16/R61=11 row at window
  6629, W1=0x0221,0x2b8d,0x010d and W2=0x012e,0x2f07,0x38d2; local
  refinement also shaped window 7397 to R61=10 and window 5861 to R61=11
- phase794 breadth/local preserved the window 6901 tail16 row,
  W1=0x221b,0x3351,0x26a1 and W2=0x2128,0x3d26,0x04b4; local refinement
  improved its local R61 side from 14 to 12, improved window 7669 from scan
  tail21 to tail19/R61=11, and improved window 6645 from scan tail22 to
  tail20/R61=12
- phase795 was weaker on tail depth, bottoming at tail19; local refinement
  preserved the window 6917 R61=11 row, improved window 3589 from R61=14 to
  R61=13, and improved window 5125 from scan tail23 to tail22/R61=12

May 23 continuation checkpoint 45:

- committed checkpoint 44 as d321d642 with author and committer set to
  kodareef5 <kodareef5@users.noreply.github.com>
- breadth phases 796-803 completed without a tail<=13 or R61<=8 move
- phase796 breadth/local preserved the window 7445 R61=10 row; local
  refinement improved window 4373 from R61=15 to R61=12 and improved
  window 6165 from scan tail21 to tail19/R61=12
- phase797 breadth produced tail17 at window 4133, tail18 at window 1573,
  and R61=11 rows at windows 5413, 3877, and 1829; local refinement
  preserved those R61=11 rows and improved windows 4133, 1573, 5669,
  and 293 on the R61 side
- phase798 breadth/local preserved the window 5685 tail16 row and the
  R61=10 rows at windows 5429 and 7221; local refinement improved
  window 2101 from R61=13 to R61=12 and improved the tail side at
  window 5429 from scan tail22 to tail21/R61=10
- phase799 local refinement shaped window 69 from scan tail22 to
  tail16/R61=12, preserved tail17 at window 6725, preserved R61=11 rows
  at windows 5445 and 837, and improved window 1093 from R61=13 to
  R61=11
- phase800 breadth/local preserved tail16 at window 2133 and tail18 rows
  at windows 3669 and 7253; local refinement shaped window 2389 from scan
  tail22 to tail18/R61=12, improved window 2133 from R61=14 to R61=13,
  and improved window 7253 from R61=14 to R61=13
- phase801 breadth/local re-hit the tail14 row at window 3173,
  W1=0x3c4a,0x0174,0x205b and W2=0x3b57,0x37bc,0x2a96; local refinement
  ...
  R61=12 to R61=11
- phase802 breadth/local preserved the window 4725 R61=10 row and the
  ...
  tail19/R61=12
- phase803 local refinement preserved the window 1925 tail17/R61=12 row and
  R61=11 rows at windows 3717, 4229, and 2181; it also improved window 2437
  from scan tail21 to tail19/R61=12 and improved window 4741 from R61=13 to
  R61=12

May 23 continuation checkpoint 46:

- committed checkpoint 45 as 7b209230 with author and committer set to
  kodareef5 <kodareef5@users.noreply.github.com>
- breadth phases 804-811 completed without a tail<=13 or R61<=8 move
- phase804 local refinement improved window 405 from scan tail22 to
  tail18/R61=11, preserved tail18 rows at windows 1173 and 4757, preserved
  R61=11 rows at windows 405, 4245, and 5525, and shaped windows 7317 and
  1429 to R61=12
- phase805 local refinement preserved tail17 at window 7333 and the window
  2725 R61=10 row; it preserved R61=11 rows at windows 933 and 6309, shaped
  window 5797 from scan R61=13 to R61=11, and improved window 7333 on the
  R61 side from 13 to 12
- phase806 was weaker, bottoming at tail19 and R61=11; local refinement
  improved window 4277 from R61=14 to R61=12, improved window 6069 from scan
  tail20 to tail19/R61=12, improved window 437 from scan tail22 to
  tail20/R61=11, and shaped window 4021 to tail20/R61=12
- phase807 breadth produced a tail15 row at window 197 and an R61=10 row at
  window 5061; local refinement preserved those rows, shaped window 7877
  from scan tail18/R61=13 to tail17/R61=10, improved window 3269 to
  R61=11, and improved window 6341 from scan tail22 to tail18/R61=13
- phase808 local refinement preserved a tail18 row at window 7893 and R61=11
  rows at windows 7381, 4053, 6613, and 725; it also improved the local
  R61 side at window 7893 from 14 to 12 and improved the tail side at
  windows 4053, 6613, and 725
- phase809 breadth/local preserved the joint tail16/R61=11 row at window
  6629, W1=0x0221,0x2b8d,0x010d and W2=0x012e,0x2f07,0x38d2; local
  refinement also shaped window 7397 to R61=10 and window 5861 to R61=11
- phase810 breadth/local preserved the window 6901 tail16 row,
  W1=0x221b,0x3351,0x26a1 and W2=0x2128,0x3d26,0x04b4; local refinement
  improved its local R61 side from 14 to 12, improved window 7669 from scan
  tail21 to tail19/R61=11, and improved window 6645 from scan tail22 to
  tail20/R61=12
...
May 23 continuation checkpoint 48:

- committed checkpoint 47 as 10f17612 with author and committer set to
  kodareef5 <kodareef5@users.noreply.github.com>
- breadth phases 820-827 completed without a tail<=13 or R61<=8 move
- phase820 local refinement improved window 405 from scan tail22 to
  tail18/R61=11, preserved tail18 rows at windows 1173 and 4757, preserved
  R61=11 rows at windows 405, 4245, and 5525, and shaped windows 7317 and
  1429 to R61=12
- phase821 local refinement preserved tail17 at window 7333 and the window
  2725 R61=10 row; it preserved R61=11 rows at windows 933 and 6309, shaped
  window 5797 from scan R61=13 to R61=11, and improved window 7333 on the
  R61 side from 13 to 12
- phase822 was weaker, bottoming at tail19 and R61=11; local refinement
  improved window 4277 from R61=14 to R61=12, improved window 6069 from scan
  tail20 to tail19/R61=12, improved window 437 from scan tail22 to
  tail20/R61=11, and shaped window 4021 to tail20/R61=12
- phase823 breadth produced a tail15 row at window 197,
  W1=0x2f1a,0x0a34,0x3867 and W2=0x2e27,0x22f0,0x0047, plus an R61=10 row
  at window 5061; local refinement preserved those rows, shaped window 7877
  from scan tail18/R61=13 to tail17/R61=10, improved window 5061 to
  tail18/R61=10 in second-stage refinement, improved window 3269 to
  R61=11, and improved window 6341 from scan tail22 to tail18/R61=13
- phase824 local refinement preserved a tail18 row at window 7893 and R61=11
  rows at windows 7381, 4053, 6613, and 725; it also improved the local
  R61 side at window 7893 from 14 to 12 and improved the tail side at
  windows 4053, 6613, and 725
- phase825 breadth/local preserved the joint tail16/R61=11 row at window
  6629, W1=0x0221,0x2b8d,0x010d and W2=0x012e,0x2f07,0x38d2; local
  refinement also shaped window 7397 to R61=10 and window 5861 to R61=11
- phase826 breadth/local preserved the window 6901 tail16 row,
  W1=0x221b,0x3351,0x26a1 and W2=0x2128,0x3d26,0x04b4; local refinement
  improved its local R61 side from 14 to 12, improved window 7669 from scan
  tail21 to tail19/R61=11, and improved window 6645 from scan tail22 to
  tail20/R61=12
- phase827 was weaker on tail depth, bottoming at tail19; local refinement
  preserved the window 6917 R61=11 row, improved window 3589 from R61=14 to
  R61=13, and improved window 5125 from scan tail23 to tail22/R61=12
- the phase820-827 frontier mix re-ran windows 197, 7877, 5061, 6629, 6901,
  and 7397 at budget1b/seed-cap256; it preserved the current anchors
  tail15/R61=13, tail16/R61=11, tail16/R61=12, and three R61=10 rows, but
  did not improve the global frontier
