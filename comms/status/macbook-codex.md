...
Checkpoint through window 1023:

```text
unique N=13 windows = 1024
prefixes covered    = 67,108,864 / 67,108,864 = 100.00%
triples covered     = 549,755,813,888
...
frontier also improved from HW8 to HW7 and repeated in nine logged windows;
