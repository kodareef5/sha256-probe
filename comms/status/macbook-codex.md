...
Checkpoint through window 789:

```text
unique N=13 windows = 790
prefixes covered    = 51,773,440 / 67,108,864 = 77.15%
triples covered     = 424,128,020,480
...
N=13 prefix surface; the added `630..789` windows only reached HW13/HW14 tails.
The latest r61-HW7 repeat is `sample_start=47054848`, with tail HW20.
